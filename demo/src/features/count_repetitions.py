...
# --------------------------------------------------------------
def count_reps(dataset, cuteoff=0.4, order=10, column="acc_r"):
    data = LowPass.low_pass_filter(
       dataset,
        col=column,
        sampling_frequency=fs,
        cutoff_frequency=cuteoff,
        order=order
    )
...
count_reps(bench_set, cuteoff=0.4)
count_reps(squat_set, cuteoff=0.35) 
count_reps(row_set, cuteoff=0.65, column="gyr_x")
count_reps(ohp_set, cuteoff=0.35)
count_reps(dead_set, cuteoff=0.4)
...
for s in df["set"].unique():
    ...
    reps = count_reps(subset, cuteoff=cuteoff, column=column) 
